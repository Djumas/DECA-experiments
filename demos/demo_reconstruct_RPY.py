...
def main(args):
    ...
    for i in tqdm(range(len(testdata))):
        ...
        if args.saveDepth or args.saveKpt or args.saveObj or args.saveMat or args.saveImages or args.saveRPY:
            os.makedirs(os.path.join(savefolder, name), exist_ok=True)

        # -- ДОБАВЛЕНО: Извлечение и перевод в градусы углов Pitch, Yaw, Roll --
        if args.saveRPY:
            ...
            rpy_file_path = os.path.join(savefolder, name, name + '_rpy.txt')
...
if __name__ == '__main__':
    ...
    # ДОБАВЛЕНО: Флаг для управления сохранением RPY
